            ...
            {action === 'new' && (
                <div className=''>
                    <form>
                        ...
                        <p className='text-gray-500 text-sm'>Give a catchy title to your place</p>
                        <input type="text" placeholder='Title of your apartment' />

                        <h2 className='text-2xl mt-4'>Address</h2>
                        <p className='text-gray-500 text-sm'>Give the address to this place</p>
                        ...
                        <div className='mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
                            <button className='flex gap-2 justify-center text-2xl text-gray-600 border bg-transparent round-2xl p-8'>
                        ...
                        <p className='text-gray-500 text-sm'>select what perks your apartment has</p>
                        ...
                        <p className='text-gray-500 text-sm'>keep a check fro cleaning the room</p>
